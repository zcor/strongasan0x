---
name: closeout
description: Close out a Strong as an 0x engineering or Roll Call session only when explicitly asked to close out, hand off, finalize, log out, or stop work. Preserve non-obvious context, validate the completed scope, and commit or push only agent-owned changes.
