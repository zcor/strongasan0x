...
# ONE-SHOT (remove after it runs): backfill chat history for the 3 active users
# from their old comments + coach notes. Idempotent; every minute until removed.
* * * * * zcor /var/www/ox/strongasan0x/ox-env/bin/python /var/www/ox/strongasan0x/manage.py backfill_chat --all >> /var/log/ox-backfill-chat.log 2>&1
